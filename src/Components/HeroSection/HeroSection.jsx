                ...
                <div className="">
                    <div className="">
                        <div className='lg:pt-32 md:pt-48 pt-24 lg:ps-10 ps-2'>
                            <h1 className="mb-2 lg:text-7xl md:text-7xl text-4xl  font-semibold  text-color-animation" >ISLAMIC SITE,</h1>
                            <h1 className="mb-5 lg:text-8xl md:text-7xl text-5xl font-bold text-color-animation">ISLAMIC NEWS</h1>
